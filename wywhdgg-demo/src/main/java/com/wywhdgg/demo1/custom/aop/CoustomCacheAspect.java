package com.wywhdgg.demo1.custom.aop;

import com.wywhdgg.demo1.custom.annotations.CoustomCache;
...
public class CoustomCacheAspect {
    ...
    @Pointcut("@annotation(com.wywhdgg.demo1.custom.annotations.CoustomCache)")
